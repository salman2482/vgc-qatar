...
<nav class="navbar navbar-expand navbar-white navbar-light p-fixed" style="background-color:#f1f1f1;padding:0;position: fixed;top:80px;z-index: 99999;width: 100%;">
    <!-- Left navbar links -->
    <!-- SEARCH FORM -->
    ...
    <ul class="navbar-nav ml-10">
       ...
       <!--  <li class="nav-item">
        ...
        <li class="nav-item bdicon">
            ...
            <i class="fas fa-edit" data-toggle="modal" data-target="#newDrill"></i>
            </a>
        </li>
    </ul>
</nav>
