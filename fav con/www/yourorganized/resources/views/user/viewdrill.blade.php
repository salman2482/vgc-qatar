...
<script>
    $( document ).ready(function() {
        ...
        $("#add_new_drill").append('<div id="new_drill" class="modal-body">  <label>New Name</label>  <input type="text" required="required" name="new_name" class="form-control" id="" placeholder="Drill New Name">  </div>');
        })
    });
</script>
<script>
    ...
    function newdrilldetailssave() {
        $("#drawdetails").submit();
    }
    $('.plantitle').change(function () { 
...
<section class="content-header drill-option-header">
    <nav class="navbar navbar-expand navbar-white navbar-light" style="background-color:#f1f1f1;padding:0">
        ...
        <ul class="navbar-nav ml-10">
            ...
            <li class="nav-item">
                <a class="nav-link" id="add_drill" data-toggle="modal" data-target="#save_as" href="#" title="SAVE AS">
    ...
    <div class="container-fluid">
        <div class="row drill-view-row-reverse">
            <aside class="main-sidebar sidebar-dark-primary elevation-4 drill-sidebar drill-box-closed" style="margin-top: 140px;background-color: #fff;position: fixed;top:12px;overflow:visible;">
                ...
                <!-- Brand Logo -->
                <a  class="brand-link hover-green" style="background-color: #000;">
                                                    ...
                                                    <div class="timeline-body">
                                                        <div class="row d-none">
                                                            <div class="col-md-2">
                                                                ...
                                                                <input required class="form-control"  id="drillname" type="text" placeholder="Drill Name" value="{{$drill->name}}" name="name">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label>Mins</label>
                                                            ...
                                                            <div class="col-md-2">
                                                                <label>Rink</label>
                                                                <div class="form-group">
                                                                    <input required class="form-control" id="rink" type="text" placeholder="Rink Name" value="{{ $drill->surface }}" name="surface">
                                                                    <br> 
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label>sports</label>
                                                                <div class="form-group">
                                                                    <input required class="form-control" id="sports" type="text" placeholder="Sport name" value="{{ $drill->sports }}"name="sports">
                                                                    <br> 
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="modal-dialog modal-sm" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button  onclick="newdrilldetailssave()" class="btn btn-primary">Save</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
