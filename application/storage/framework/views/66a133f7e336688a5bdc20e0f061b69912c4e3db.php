            ...
            <div class="row clearfix ">
                ...
                <div class="form-column column col-lg-6 offset-lg-3 col-md-12 col-sm-12 shadow p-3 mb-5 bg-white rounded">
                    ...
                    <div class="styled-form login-form">
                        <form method="post" action="<?php echo e(url('cafm/login')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('front-end.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alrifaig/public_html/application/resources/views/front-end/CAFM-login/CAFM-login.blade.php ENDPATH**/ ?>