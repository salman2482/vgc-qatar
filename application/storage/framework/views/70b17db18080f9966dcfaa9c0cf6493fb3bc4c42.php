                ...
                <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                    <ul class="navigation clearfix">
                        ...
                        <li class="dropdown"><a ><?php echo e(__('fl.Services')); ?></a>
                            <ul>
                                <li><a
                                        href="<?php echo e(route('front.corporate-services')); ?>"><?php echo e(__('fl.Corporate Services')); ?></a>
                                </li>
                                <li><a
                                        href="<?php echo e(route('front.retail-services')); ?>"><?php echo e(__('fl.Retail Services')); ?></a>
                                </li>
                                <li><a href="<?php echo e(route('front.our-clients')); ?>"><?php echo e(__('fl.Our Clients')); ?></a></li>
                                <li><a href="<?php echo e(route('front.our-projects')); ?>"><?php echo e(__('fl.Our Projects')); ?></a>
                                </li>
                        ...
                        <li class="dropdown"><a><?php echo e(__('fl.Properties')); ?></a>
                            <ul>
                                <li><a
                                        href="<?php echo e(route('front.property.index')); ?>"><?php echo e(__('fl.All Properties')); ?></a>
                                </li>
                        ...
                        <li class="dropdown"><a ><?php echo e(__('fl.Products')); ?></a>
                            ...
                            <ul>
                                <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a
                                            href="<?php echo e(route('front.category.products', $item->id)); ?>"><?php echo e($item->name); ?></a>
                                    </li>
                        ...
                        <li class="dropdown"><a ><?php echo e(__('fl.Our Policies')); ?></a>
                            <ul>
                                <li><a
                                        href="<?php echo e(url('/enivromental-policy')); ?>"><?php echo e(__('fl.Environmental Policy')); ?></a>
                                </li>
                                <li><a
                                        href="<?php echo e(route('front.health-safety-policy')); ?>"><?php echo e(__('fl.Health Safety Policy')); ?></a>
                                </li>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                        <li>
                            <a href="<?php echo e(route('front.employee-dashboard')); ?>"><?php echo e('Dashboard'); ?></a>
                        </li>
                    <?php endif; ?>
                    </ul>
                </div>
...
<?php /**PATH /home/alrifaig/public_html/application/resources/views/front-end/partials/navbar/desktop-nav.blade.php ENDPATH**/ ?>