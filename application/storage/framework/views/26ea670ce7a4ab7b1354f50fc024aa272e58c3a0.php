...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <!--careerapply table-->
            <?php echo $__env->make('pages.careerapply.components.table.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!--careerapply table-->
        </div>
    </div>
    <!--page content -->
...
<?php echo $__env->make('layout.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\wamp64\www\application\resources\views/pages/careerapply/wrapper.blade.php ENDPATH**/ ?>