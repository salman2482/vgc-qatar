<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum" id="careers-checkbox-actions-container">
    <!--button-->
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-danger" 
                data-type="form"
                data-ajax-type="POST" 
                data-form-id="careers-list-table" 
                data-url="<?php echo e(url('/careers/delete?type=bulk')); ?>"
                ...
                id="checkbox-actions-delete-careers">
        ...
        <button type="button"
            ...
            data-url="<?php echo e(urlResource('/careers/change-category')); ?>"
            data-action-url="<?php echo e(urlResource('/careers/change-category?type=bulk')); ?>" data-action-method="POST"
            data-action-type="form" data-action-form-id="main-body" data-loading-target="actionsModalBody"
            data-skip-checkboxes-reset="TRUE" id="checkbox-actions-change-category-careers">
...
<?php /**PATH H:\wamp64\www\application\resources\views/pages/careerapply/components/actions/checkbox-actions.blade.php ENDPATH**/ ?>