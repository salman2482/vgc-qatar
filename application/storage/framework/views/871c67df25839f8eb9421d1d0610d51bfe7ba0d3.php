                ...
                <td align="center">
                    <table class="table-3" border="0" width="100%" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                            <tr>
                                <td class="td-1">
                                    <p>Your account has been created. You will be provide with the best service.</p>
                                </td>
                            </tr>
                            <tr>
                                <td class="td-1">
                                    <table class="table-gray" cellpadding="5">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-2"><?php echo e($data['password'] ?? ''); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <p>You have to wait until, you are verified.</p>
                                </td>
                            </tr>
                            <tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center"><a class="button"
                                                                        ...
                                                                        rel="noopener">Login To You Account</a></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
...
<?php /**PATH /home/alrifaig/public_html/application/resources/views/users/register.blade.php ENDPATH**/ ?>