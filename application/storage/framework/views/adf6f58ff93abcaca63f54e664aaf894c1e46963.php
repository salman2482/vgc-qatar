                ...
                <td align="center">
                    <table class="table-1" border="0" width="100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td align="left">
                                    <h1><?php echo e($data['type'] ?? 'Email From Front End'); ?></h1>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                                    ...
                                    <table class="table-gray" cellpadding="5">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="td-2"><?php echo e($data['name'] ?? ''); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Email</strong></td>
                                                <td class="td-2"><?php echo e($data['email'] ?? ''); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Phone</strong></td>
                                                <td class="td-2"><?php echo e($data['phone'] ?? ''); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Subject</strong></td>
                                                <td class="td-2"><?php echo e($data['subject'] ?? ''); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Message</strong></td>
                                                <td class="td-2"><?php echo e($data['message'] ?? ''); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
...
<?php /**PATH /home/alrifaig/public_html/application/resources/views/users/complain.blade.php ENDPATH**/ ?>