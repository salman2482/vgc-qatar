...
return [
  ...
  'ordering_employees' => [
    ...
    // trustech front project
    'ordering_frontprojects' => [
        'sort_by' => 'id',
        'sort_order' => 'DESC',
    ],

    // trustech front career
    'ordering_frontcareers' => [
        'sort_by' => 'id',
        'sort_order' => 'DESC',
    ],

    // trustech front client
    'ordering_frontclients' => [
        'sort_by' => 'id',
        'sort_order' => 'DESC',
    ],
    
    // trustech front banner
    'ordering_frontbanners' => [
        'sort_by' => 'id',
        'sort_order' => 'DESC',
    ],

    //sorting vendor quotations
    'ordering_vendorpos' => [
        'sort_by' => 'id',
        'sort_order' => 'DESC',
    ],
    ...
    'ordering_vendorinvoices' => [
        'sort_by' => 'id',
        'sort_order' => 'DESC',
    ],
    //sorting ordering_corporateservices
    'ordering_corporateservices' => [
        'sort_by' => 'id',
        'sort_order' => 'DESC',
    ],
    
    
    //sorting ordering_subcorporateservices
    'ordering_subcorporateservices' => [
        'sort_by' => 'id',
        'sort_order' => 'DESC',
    ],
    
    //sorting ordering_subproducts
    'ordering_subproducts' => [
        'sort_by' => 'id',
        'sort_order' => 'DESC',
    ],
