                ...
                <td align="center">
                    <table class="table-3" border="0" width="100%" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                            <tr>
                                <td class="td-1">
                                    <p>Client {{ $data->full_name }} have booked your service.</p>
                                </td>
                            </tr>
                            <tr>
                                <td class="td-1">
                                    <table class="table-gray" cellpadding="5">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-2">{{ $schedule->start }}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Service Name </strong></td>
                                                <td class="td-2">{{ $service->title }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
