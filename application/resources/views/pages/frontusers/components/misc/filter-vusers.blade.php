<!-- right-sidebar -->
<div class="right-sidebar" id="sidepanel-filter-vusers">
    <form>
        <div class="slimscrollright">
            <!--title-->
            <div class="rpanel-title">
                <i class="icon-Filter-2"></i>{{ cleanLang(__('lang.filter_vusers')) }}
                <span>
                    <i class="ti-close js-toggle-side-panel" data-target="sidepanel-filter-vusers"></i>
                </span>
            </div>
            <!--title-->
            <!--body-->
            <div class="r-panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select name="filter_name" id="filter_name"
                                    class="form-control form-control-sm js-select2-basic-search select2-multiple select2-hidden-accessible"
                                    multiple="multiple" tabindex="-1" aria-hidden="true"
                                    data-ajax--url="{{ url('/') }}/feed/vusers?type=client"></select>
                                <!--select2 basic search-->
                            </div>
                        </div>
                    </div>
                ...
                <div class="buttons-block">
                    ...
                    <button type="button" class="btn btn-rounded-x btn-danger js-ajax-ux-request apply-filter-button"
                        data-url="{{ urlResource('/vusers/search') }}" data-type="form" data-ajax-type="GET">{{ cleanLang(__('lang.apply_filter')) }}</button>
                </div>
