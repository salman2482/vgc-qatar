<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum" id="banners-checkbox-actions-container">
    <!--button-->
    ...
    <div class="x-buttons">
        ...
        <button type="button"
            ...
            data-url="{{ urlResource('/banners/change-category') }}"
            data-action-url="{{ urlResource('/banners/change-category?type=bulk') }}" data-action-method="POST"
            data-action-type="form" data-action-form-id="main-body" data-loading-target="actionsModalBody"
            data-skip-checkboxes-reset="TRUE" id="checkbox-actions-change-category-banners">
