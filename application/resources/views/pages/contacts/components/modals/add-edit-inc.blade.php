<div class="row">
    <div class="col-lg-12">
        ...
        <div>
            ...
            <div class="form-group row">
                <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ cleanLang(__('Client Signature')) }}*</label>
                <div class="col-sm-12">
                    <div class="dropzone dz-clickable" id="client_signature">
