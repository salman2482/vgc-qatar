<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum" id="subcorporateservices-checkbox-actions-container">
    <!--button-->
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-danger" 
                data-type="form"
                data-ajax-type="POST" 
                data-form-id="subcorporateservices-list-table" 
                data-url="{{ url('/subcorporateservices/delete?type=bulk') }}"
                data-confirm-title="{{ cleanLang(__('lang.delete_selected_items')) }}" 
                data-confirm-text="{{ cleanLang(__('lang.are_you_sure')) }}"
                id="checkbox-actions-delete-subcorporateservices">
        ...
        <button type="button"
            ...
            data-url="{{ urlResource('/subcorporateservices/change-category') }}"
            data-action-url="{{ urlResource('/subcorporateservices/change-category?type=bulk') }}" data-action-method="POST"
            data-action-type="form" data-action-form-id="main-body" data-loading-target="actionsModalBody"
            data-skip-checkboxes-reset="TRUE" id="checkbox-actions-change-category-subcorporateservices">
