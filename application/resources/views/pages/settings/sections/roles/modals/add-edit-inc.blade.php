        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <!--rfms-->
                    <tr>
                        <td>{{ cleanLang(__('Rfm')) }}</td>
                        <td>
                            <div class="form-group row m-0">
                                <div class="col-12 text-center">
                                    <select class="select2-basic form-control form-control-sm" name="role_rfms"
                                        data-allow-clear="false">
                                        <option value="0" {{ runtimePreselected($role->role_rfms ?? '', 0) }}>
                                            {{ cleanLang(__('lang.none')) }}</option>
                                        <option value="1" {{ runtimePreselected($role->role_rfms ?? '', 1) }}>
                                            {{ cleanLang(__('lang.view')) }}</option>
                                        <option value="2" {{ runtimePreselected($role->role_rfms ?? '', 2) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }}</option>
                                        <option value="3" {{ runtimePreselected($role->role_rfms ?? '', 3) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }} +
                                            {{ cleanLang(__('lang.delete')) }}</option>
                                    </select>
                        ...
                        <td>
                            <div class="form-group form-group-checkbox row m-0 w-98">
                                <div class="col-12 text-center p-t-5">
                                    <input type="checkbox" id="role_rfms_scope" name="role_rfms_scope"
                                        class="filled-in chk-col-light-blue"
                                        {{ runtimePrechecked($role->role_rfms_scope ?? '') }}>
                                    <label for="role_rfms_scope"></label>
                                </div>
                            </div>
                        </td>
                    </tr>
                    {{-- property --}}
                    <tr>
                        <td>{{ cleanLang(__('Property')) }}</td>
                        <td>
                            <div class="form-group row m-0">
                                <div class="col-12 text-center">
                                    <select class="select2-basic form-control form-control-sm" name="role_property"
                                        data-allow-clear="false">
                                        <option value="0" {{ runtimePreselected($role->role_property ?? '', 0) }}>
                                            {{ cleanLang(__('lang.none')) }}</option>
                                        <option value="1" {{ runtimePreselected($role->role_property ?? '', 1) }}>
                                            {{ cleanLang(__('lang.view')) }}</option>
                                        <option value="2" {{ runtimePreselected($role->role_property ?? '', 2) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }}</option>
                                        <option value="3" {{ runtimePreselected($role->role_property ?? '', 3) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }} +
                                            {{ cleanLang(__('lang.delete')) }}</option>
                                    </select>
                        ...
                        <td>
                            <div class="form-group form-group-checkbox row m-0 w-98">
                                <div class="col-12 text-center p-t-5">
                                    <input type="checkbox" id="role_property_scope" name="role_property_scope"
                                        class="filled-in chk-col-light-blue" disabled>
                                    <label for="role_property_scope"></label>
                                </div>
                            </div>
                        </td>
                    </tr>
                    ...
                    {{-- G-Documents --}}
                    <tr>
                        <td>{{ cleanLang(__('General Documents')) }}</td>
                        <td>
                            <div class="form-group row m-0">
                                <div class="col-12 text-center">
                                    <select class="select2-basic form-control form-control-sm" name="role_documents"
                                        data-allow-clear="false">
                                        <option value="0" {{ runtimePreselected($role->role_documents ?? '', 0) }}>
                                            {{ cleanLang(__('lang.none')) }}</option>
                                        <option value="1" {{ runtimePreselected($role->role_documents ?? '', 1) }}>
                                            {{ cleanLang(__('lang.view')) }}</option>
                                        <option value="2" {{ runtimePreselected($role->role_documents ?? '', 2) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }}</option>
                                        <option value="3" {{ runtimePreselected($role->role_documents ?? '', 3) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }} +
                                            {{ cleanLang(__('lang.delete')) }}</option>
                                    </select>
                        ...
                        <td>
                            <div class="form-group form-group-checkbox row m-0 w-98">
                                <div class="col-12 text-center p-t-5">
                                    <input type="checkbox" id="role_documents" name="role_scope_documents"
                                        class="filled-in chk-col-light-blue" disabled>
                                    <label for="role_scope_controls"></label>
                                </div>
                            </div>
                        </td>
                    </tr>
                    {{-- Quotations --}}
                    <tr>
                        <td>{{ cleanLang(__('Quotations')) }}</td>
                        <td>
                            <div class="form-group row m-0">
                                <div class="col-12 text-center">
                                    <select class="select2-basic form-control form-control-sm" name="role_quotations"
                                        data-allow-clear="false">
                                        <option value="0" {{ runtimePreselected($role->role_quotations ?? '', 0) }}>
                                            {{ cleanLang(__('lang.none')) }}</option>
                                        <option value="1" {{ runtimePreselected($role->role_quotations ?? '', 1) }}>
                                            {{ cleanLang(__('lang.view')) }}</option>
                                        <option value="2" {{ runtimePreselected($role->role_quotations ?? '', 2) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }}</option>
                                        <option value="3" {{ runtimePreselected($role->role_quotations ?? '', 3) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }} +
                                            {{ cleanLang(__('lang.delete')) }}</option>
                                    </select>
                        ...
                        <td>
                            <div class="form-group form-group-checkbox row m-0 w-98">
                                <div class="col-12 text-center p-t-5">
                                    <input type="checkbox" id="role_quotations" name="role_scope_quotations"
                                        class="filled-in chk-col-light-blue" disabled>
                                    <label for="role_scope_controls"></label>
                                </div>
                            </div>
                    ...
                    {{-- Govt-document --}}
                    <tr>
                        <td>{{ cleanLang(__('Govt Documents')) }}</td>
                        <td>
                            <div class="form-group row m-0">
                                <div class="col-12 text-center">
                                    <select class="select2-basic form-control form-control-sm" name="role_govtdocs"
                                        data-allow-clear="false">
                                        <option value="0" {{ runtimePreselected($role->role_govtdocs ?? '', 0) }}>
                                            {{ cleanLang(__('lang.none')) }}</option>
                                        <option value="1" {{ runtimePreselected($role->role_govtdocs ?? '', 1) }}>
                                            {{ cleanLang(__('lang.view')) }}</option>
                                        <option value="2" {{ runtimePreselected($role->role_govtdocs ?? '', 2) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }}</option>
                                        <option value="3" {{ runtimePreselected($role->role_govtdocs ?? '', 3) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }} +
                                            {{ cleanLang(__('lang.delete')) }}</option>
                                    </select>
                        ...
                        <td>
                            <div class="form-group form-group-checkbox row m-0 w-98">
                                <div class="col-12 text-center p-t-5">
                                    <input type="checkbox" id="role_scope_govt_docs" name="role_scope_govt_docs"
                                        class="filled-in chk-col-light-blue" disabled>
                                    <label for="role_scope_govt_docs"></label>
                                </div>
                            </div>
                        </td>
                    </tr>
                    {{-- LPO --}}
                    <tr>
                        <td>{{ cleanLang(__('LPO')) }}</td>
                        <td>
                            <div class="form-group row m-0">
                                <div class="col-12 text-center">
                                    <select class="select2-basic form-control form-control-sm" name="role_lpos"
                                        data-allow-clear="false">
                                        <option value="0" {{ runtimePreselected($role->role_lpos ?? '', 0) }}>
                                            {{ cleanLang(__('lang.none')) }}</option>
                                        <option value="1" {{ runtimePreselected($role->role_lpos ?? '', 1) }}>
                                            {{ cleanLang(__('lang.view')) }}</option>
                                        <option value="2" {{ runtimePreselected($role->role_lpos ?? '', 2) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }}</option>
                                        <option value="3" {{ runtimePreselected($role->role_lpos ?? '', 3) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }} +
                                            {{ cleanLang(__('lang.delete')) }}</option>
                                    </select>
                        ...
                        <td>
                            <div class="form-group form-group-checkbox row m-0 w-98">
                                <div class="col-12 text-center p-t-5">
                                    <input type="checkbox" id="role_scope_lpos" name="role_scope_lpos"
                                        class="filled-in chk-col-light-blue" disabled>
                                    <label for="role_scope_lpos"></label>
                                </div>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group form-group-checkbox row m-0 w-98">
                                <div class="col-12 text-center p-t-5">
                                    <input type="checkbox" id="role_contract" name="role_scope_contracts"
                                        class="filled-in chk-col-light-blue" disabled>
                                    <label for="role_scope_controls"></label>
                                </div>
                            </div>
                    ...
                    {{-- Vendor RFQ --}}
                    <tr>
                        <td>{{ cleanLang(__('Vendor RFQ')) }}</td>
                        <td>
                            <div class="form-group row m-0">
                                <div class="col-12 text-center">
                                    <select class="select2-basic form-control form-control-sm" name="role_vendorrfq"
                                        data-allow-clear="false">
                                        <option value="0" {{ runtimePreselected($role->role_vendorrfq ?? '', 0) }}>
                                            {{ cleanLang(__('lang.none')) }}</option>
                                        <option value="1" {{ runtimePreselected($role->role_vendorrfq ?? '', 1) }}>
                                            {{ cleanLang(__('lang.view')) }}</option>
                                        <option value="2" {{ runtimePreselected($role->role_vendorrfq ?? '', 2) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }}</option>
                                        <option value="3" {{ runtimePreselected($role->role_vendorrfq ?? '', 3) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }} +
                                            {{ cleanLang(__('lang.delete')) }}</option>
                                    </select>
                        ...
                        <td>
                            <div class="form-group form-group-checkbox row m-0 w-98">
                                <div class="col-12 text-center p-t-5">
                                    <input type="checkbox" id="role_vendorrfq" name="role_scope_vendorrfq"
                                        class="filled-in chk-col-light-blue" disabled>
                                    <label for="role_scope_controls"></label>
                                </div>
                            </div>
                    ...
                    {{-- Vendor QTN --}}
                    <tr>
                        <td>{{ cleanLang(__('Vendor QTN')) }}</td>
                        <td>
                            <div class="form-group row m-0">
                                <div class="col-12 text-center">
                                    <select class="select2-basic form-control form-control-sm" name="role_vendorqtn"
                                        data-allow-clear="false">
                                        <option value="0" {{ runtimePreselected($role->role_vendorqtn ?? '', 0) }}>
                                            {{ cleanLang(__('lang.none')) }}</option>
                                        <option value="1" {{ runtimePreselected($role->role_vendorqtn ?? '', 1) }}>
                                            {{ cleanLang(__('lang.view')) }}</option>
                                        <option value="2" {{ runtimePreselected($role->role_vendorqtn ?? '', 2) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }}</option>
                                        <option value="3" {{ runtimePreselected($role->role_vendorqtn ?? '', 3) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }} +
                                            {{ cleanLang(__('lang.delete')) }}</option>
                                    </select>
                        ...
                        <td>
                            <div class="form-group form-group-checkbox row m-0 w-98">
                                <div class="col-12 text-center p-t-5">
                                    <input type="checkbox" id="role_vendorqtn" name="role_scope_vendorqtn"
                                        class="filled-in chk-col-light-blue" disabled>
                                    <label for="role_scope_vendorqtn"></label>
                                </div>
                            </div>
                        </td>
                    </tr>
                    ...
                    {{-- Vendor PO --}}
                    <tr>
                        <td>{{ cleanLang(__('Vendor PO')) }}</td>
                        <td>
                            <div class="form-group row m-0">
                                <div class="col-12 text-center">
                                    <select class="select2-basic form-control form-control-sm" name="role_vendorpo"
                                        data-allow-clear="false">
                                        <option value="0" {{ runtimePreselected($role->role_vendorpo ?? '', 0) }}>
                                            {{ cleanLang(__('lang.none')) }}</option>
                                        <option value="1" {{ runtimePreselected($role->role_vendorpo ?? '', 1) }}>
                                            {{ cleanLang(__('lang.view')) }}</option>
                                        <option value="2" {{ runtimePreselected($role->role_vendorpo ?? '', 2) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }}</option>
                                        <option value="3" {{ runtimePreselected($role->role_vendorpo ?? '', 3) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }} +
                                            {{ cleanLang(__('lang.delete')) }}</option>
                                    </select>
                        ...
                        <td>
                            <div class="form-group form-group-checkbox row m-0 w-98">
                                <div class="col-12 text-center p-t-5">
                                    <input type="checkbox" id="role_vendorpo" name="role_scope_vendorpo"
                                        class="filled-in chk-col-light-blue" disabled>
                                    <label for="role_scope_vendorpo"></label>
                                </div>
                            </div>
                        </td>
                    </tr>
                    ...
                    {{-- Vendor Invoice --}}
                    <tr>
                        <td>{{ cleanLang(__('Vendor Invoice')) }}</td>
                        <td>
                            <div class="form-group row m-0">
                                <div class="col-12 text-center">
                                    <select class="select2-basic form-control form-control-sm" name="role_vendorinvoice"
                                        data-allow-clear="false">
                                        <option value="0"
                                            {{ runtimePreselected($role->role_vendorinvoice ?? '', 0) }}>
                                            {{ cleanLang(__('lang.none')) }}</option>
                                        <option value="1"
                                            {{ runtimePreselected($role->role_vendorinvoice ?? '', 1) }}>
                                            {{ cleanLang(__('lang.view')) }}</option>
                                        <option value="2"
                                            {{ runtimePreselected($role->role_vendorinvoice ?? '', 2) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }}</option>
                                        <option value="3"
                                            {{ runtimePreselected($role->role_vendorinvoice ?? '', 3) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }} +
                                            {{ cleanLang(__('lang.delete')) }}</option>
                                    </select>
                        ...
                        <td>
                            <div class="form-group form-group-checkbox row m-0 w-98">
                                <div class="col-12 text-center p-t-5">
                                    <input type="checkbox" id="role_vendorinvoice" name="role_scope_vendorinvoice"
                                        class="filled-in chk-col-light-blue" disabled>
                                    <label for="role_scope_vendorinvoice"></label>
                                </div>
                            </div>
                        </td>
                    </tr>

                    {{-- Front Project & Client career --}}
                    {{-- (Project, Client, Career, Corporate Services) --}}
                    <tr>
                        <td>{{ cleanLang(__('Front VIew')) }}</td>
                        <td>
                            <div class="form-group row m-0">
                                <div class="col-12 text-center">
                                    <select class="select2-basic form-control form-control-sm"
                                        name="role_project_client" data-allow-clear="false">
                                        <option value="0"
                                            {{ runtimePreselected($role->role_project_client ?? '', 0) }}>
                                            {{ cleanLang(__('lang.none')) }}</option>
                                        <option value="1"
                                            {{ runtimePreselected($role->role_project_client ?? '', 1) }}>
                                            {{ cleanLang(__('lang.view')) }}</option>
                                        <option value="2"
                                            {{ runtimePreselected($role->role_project_client ?? '', 2) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }}</option>
                                        <option value="3"
                                            {{ runtimePreselected($role->role_project_client ?? '', 3) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }} +
                                            {{ cleanLang(__('lang.delete')) }}</option>
                                    </select>
                        ...
                        <td>
                            <div class="form-group form-group-checkbox row m-0 w-98">
                                <div class="col-12 text-center p-t-5">
                                    <input type="checkbox" id="role_project_client" name="role_scope_project_client"
                                        class="filled-in chk-col-light-blue" disabled>
                                    <label for="role_scope_project_client"></label>
                                </div>
                            </div>
                        </td>
                    </tr>
