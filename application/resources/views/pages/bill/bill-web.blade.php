            ...
            <div class="col-12">
                ...
                <div class="text-left">
                    ...
                    @if ( $bill->bill_status == 'paid')
                        <a 
                            href="{{route('admin.acceptInvoice',$bill->bill_invoiceid )}}" 
                            class="btn btn-info float-right" 
                            style="margin-top: -20px; {{$bill->bill_status == 'accept' ? 'background-color:white; color:black;pointer-events: none; ' : 'Accept'}}"
                        >
                        {{ $bill->bill_status == 'Accepted' ? 'Accepted' : 'Accept'}}
                        </a>
                    @endif
                    @endif
                ...
                <div class="p-t-25 invoice-pay" id="invoice-buttons-container">
                    <div class="text-right">
                        ...
                        <a 
                            ...
                            href="{{route('client.authenticateInvoice',$bill->bill_invoiceid)}}"  
                            @if( $bill->bill_status == 'due')
                            style=" color:white"
                            @else
                            style="pointer-events: none; background-color:white; color:black"
                            @endif
                        > 
