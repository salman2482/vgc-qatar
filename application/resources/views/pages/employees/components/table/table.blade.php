<div class="card count-{{ @count($contacts) }}" id="employees-table-wrapper">
    <div class="card-body">
                    ...
                    <thead>
                        <tr>
                            @if (config('visibility.contacts_col_checkboxes'))
                                <th class="contacts_col_id"><a class="js-ajax-ux-request js-list-sorting" id="sort_id"
                                        href="javascript:void(0)"
                                        data-url="{{ urlResource('/employeeusers?action=sort&orderby=id&sortorder=asc') }}">{{ cleanLang(__('ID')) }}<span
                            ...
                            <th class="contacts_col_first_name"><a class="js-ajax-ux-request js-list-sorting"
                                    ...
                                    data-url="{{ urlResource('/employeeusers?action=sort&orderby=first_name&sortorder=asc') }}">{{ cleanLang(__('lang.name')) }}<span
                                        class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                            </th>

                            <th class="contacts_col_email"><a class="js-ajax-ux-request js-list-sorting" id="sort_email"
                                    href="javascript:void(0)"
                                    data-url="{{ urlResource('/employeeusers?action=sort&orderby=email&sortorder=asc') }}">{{ cleanLang(__('lang.email')) }}<span
                            ...
                            <th class="contacts_col_phone"><a class="js-ajax-ux-request js-list-sorting" id="sort_phone"
                                    href="javascript:void(0)"
                                    data-url="{{ urlResource('/employeeusers?action=sort&orderby=phone&sortorder=asc') }}">{{ cleanLang(__('lang.phone')) }}<span
                                        class="sorting-icons"><i class="ti-arrows-vertical"></i></span></th>
                            @if (config('visibility.contacts_col_last_active'))
                                <th class="contacts_col_last_active"><a class="js-ajax-ux-request js-list-sorting"
                                        ...
                                        data-url="{{ urlResource('/employeeusers?action=sort&orderby=last_seen&sortorder=asc') }}">{{ cleanLang(__('lang.last_seen')) }}<span
                                            class="sorting-icons"><i class="ti-arrows-vertical"></i></span></th>
                            @endif
