<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum" id="clients-checkbox-actions-container">
    <!--button-->
    ...
    <div class="x-buttons">
        ...
        <button type="button"
            ...
            data-url="{{ urlResource('/clients/change-category') }}"
            data-action-url="{{ urlResource('/clients/change-category?type=bulk') }}" data-action-method="POST"
            data-action-type="form" data-action-form-id="main-body" data-loading-target="actionsModalBody"
            data-skip-checkboxes-reset="TRUE" id="checkbox-actions-change-category-clients">
