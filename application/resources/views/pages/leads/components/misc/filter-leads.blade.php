            ...
            <div class="r-panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <select name="filter_lead_status" id="filter_lead_status"
                                    ...
                                    <option value="{{ $status->leadstatus_id }}">{{ runtimeLang($status->leadstatus_title) }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="fields">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input class="mysql-date" type="hidden" id="filter_lead_last_contacted_start" name="filter_lead_last_contacted_start"
                                    value="">
                            </div>
                            <div class="col-md-6">
                ...
                <div class="filter-block">
                    ...
                    <div class="fields">
                        <div class="row">
                            <div class="col-md-6">
                                <input type="number" class="form-control form-control-sm" placeholder="{{ cleanLang(__('lang.minimum')) }}"
                                    name="filter_lead_value_min" id="filter_lead_value_min">
                            </div>
                            <div class="col-md-6">
                                <input type="number" class="form-control form-control-sm" placeholder="{{ cleanLang(__('lang.maximum')) }}"
                                    name="filter_lead_value_max" id="filter_lead_value_max">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="buttons-block">
                    ...
                    <button type="button" class="btn btn-rounded-x btn-danger js-ajax-ux-request apply-filter-button"
                        data-url="{{ urlResource('/leads/search') }}"
