<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum" id="careers-checkbox-actions-container">
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-danger" 
                ...
                data-url="{{ url('/careers/delete?type=bulk') }}"
        ...
        <button type="button"
            ...
            data-url="{{ urlResource('/careers/change-category') }}"
            data-action-url="{{ urlResource('/careers/change-category?type=bulk') }}" data-action-method="POST"
