        ...
        <div class="row page-titles">
            ...
            <div class="col-md-12 col-lg-7 align-self-center list-pages-crumbs" id="breadcrumbs">
                ...
                <a id="InvoiceTitleAttached" class="">
                    <h3 class="text-themecolor" id="InvoiceTitleProject">Candidate Name -
                        {{$careerapply->first_name.' '.$careerapply->middle_name .''.$careerapply->last_name}}
                        </h3>
                </a>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item  active active-bread-crumb ">{{ $careerapply->qtn_ref_no }}</li>
                </ol>
                <!--crumbs-->
            </div>
        </div>
...
<a class="h1" href="javascript:void(0);" >No Form Submitted</a>

<a href="{{route('frontcareers.index')}}" class="btn btn-info float-right">Go Back To Careers</a>
</div>
@endif

<script>
    $('#careerapply_status').on('change', function(){
    // alert();
