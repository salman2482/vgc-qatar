...
@section('content')
    <div class="page-wrapper">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{route('front.vendorQuotation.update',$payload['quotation']->id)}}" method="POST" enctype="multipart/form-data">
                                @method('PUT') @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6">
        ...
        <option value="{{ $item->rfq_ref }}" {{$item->rfq_ref == $payload['quotation']->rfq_ref ? 'selected' : ''}}>
                                                            {{ $item->rfq_ref }}
                                                        </option>
                                                    @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="receiving_date" class="form-control" id="receiving_date"
                                                value="{{$payload['quotation']->receiving_date}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                value="{{$payload['quotation']->category}}" readonly>
                                            </div>
                                        </div>
                                        {{-- <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="">QTN REF NO.</label>
                                                <input type="text" name="qtn_ref_no" class="form-control">
                                            </div>
                                        </div> --}}
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                value="{{$payload['quotation']->devlivery_time}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                value="{{$payload['quotation']->total_value}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
