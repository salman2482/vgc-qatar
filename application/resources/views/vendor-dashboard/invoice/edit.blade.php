            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('front.vendorInvoice.update',$payload['invoice']->id)}}" method="POST" enctype="multipart/form-data"> 
                                @csrf
                                @method('PUT')
                                <div class="form-body">
                                    @if($payload['invoice']->status == 'Request For Amendment')
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label for="Reason">Reason</label>
                                        </div>
                                        <div class="col-md-10">
                                            <textarea name="reason" class="form-control" style="color: black;" id="reason" cols="30" rows="4" readonly>{{$payload['invoice']->reason ?? ''}}</textarea>
                                        </div>
                                    </div>
                                    @endif
                                    <br>
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <select name="lpo_ref" id="lpo_ref_select" class="form-control">
                                                ...
                                                @foreach ($pos as $item)
    <option value="{{ $item->po_ref }}"  {{$item->po_ref == $payload['invoice']->lpo_ref ? 'selected' : ''}}>
                                                        {{ $item->po_ref }}
                                                    </option>
                                                @endforeach
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" name="delivery_date" value="{{$payload['invoice']->delivery_date}}" class="form-control" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="category" id="category" value="{{$payload['invoice']->category}}" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="">INVOICE REF NO.</label>
                                            <div class="mb-3">
                                            <input type="text" name="invoice_ref_no" value="{{$payload['invoice']->invoice_ref_no}}" class="form-control" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="total_value" id="total_value" value="{{$payload['invoice']->total_value}}" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
