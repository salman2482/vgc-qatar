<html lang="zxx" class="js-focus-visible" data-js-focus-visible=""><head><style id="stndz-style">div[class*="item-container-obpd"], a[data-redirect*="paid.outbrain.com"], a[onmousedown*="paid.outbrain.com"] { display: none !important; } a div[class*="item-container-ad"] { height: 0px !important; overflow: hidden !important; position: absolute !important; } div[data-item-syndicated="true"] { display: none !important; } .grv_is_sponsored { display: none !important; } .zergnet-widget-related { display: none !important; } </style>
    ...
    <!--/Style-CSS -->
    <link rel="stylesheet" href="https://cosplay-exchange.com/comming/css/style.css" type="text/css" media="all">

    <link href="//fonts.googleapis.com/css2?family=Montserrat:wght@300;400;600;900&amp;display=swap" rel="stylesheet">

    <!-- font-awesome-icons -->
    <link href="https://cosplay-exchange.com/comming/css/font-awesome.css" rel="stylesheet">
    ...
    <meta name="csrf-token" content="YBAfuqSIv9wTvS8qXpxtudLPUPd91idSuZKeDUXG">
...
<section class="w3l-coming-soon-page">
    <div class="coming-page-info-6">
        <div class="wrapper">
            ...
            <div class="coming-block">
                ...
                <img class="m-logo" src="{{ asset('storage/public/email-logo.png') }}" width="70%" style="margin: 0px auto; ">
                ...
                <form action="javascript:void()" method="POST" id="notifyMail1">
                    <input type="hidden" name="_token" value="YBAfuqSIv9wTvS8qXpxtudLPUPd91idSuZKeDUXG">                    <p>Notify me when we go live:</p>
                    <div class="input">
    ...
    <script src="https://cosplay-exchange.com/comming/js/jquery-3.3.1.min.js"></script>
    <script>
        (() => {
            // Specify the deadline date
            const deadlineDate = new Date('August 20, 2021 23:59:59').getTime();
