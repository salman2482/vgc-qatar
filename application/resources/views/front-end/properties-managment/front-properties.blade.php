                ...
                <div class="form-column col-lg-12 col-md-12 col-sm-12 mt-3">
                    <div class="inner-column p-3">
                        ...
                        <div class="contact-form">
                            <form action="{{ route('front.properties.search') }}" method="POST">
                                @csrf
                                <div class="row clearfix">
                                            ...
                                            @foreach ($properties as $item)
                                                ...
                                                <div
                                                            ...
                                                            <div class="overlay-box">
                                                                <div class="overlay-inner">
                                                                    <div class="content">
                                                                        <h3>
                                                                            <a
                                                                                href="{{ route('front.property.details', $item->id) }}">{{ $item->title }}</a>
                                                                        </h3>
                                                                        <div class="text">
                                                    ...
                                                    <img class="status-img"
                                                        src="{{ asset('storage/public/product_status/' . $item->property_status . '.png') }}"
