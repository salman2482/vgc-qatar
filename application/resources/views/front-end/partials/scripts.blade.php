...
<script src="{{asset('public/front-end/js/jquery.mCustomScrollbar.concat.min.js')}}"></script>
<script src="{{asset('public/front-end/js/jquery.fancybox.js')}}"></script>
<script src="{{asset('public/front-end/js/appear.js')}}"></script>
<script src="{{asset('public/front-end/js/owl.js')}}"></script>
<script src="{{asset('public/front-end/js/wow.js')}}"></script>
<script src="{{asset('public/front-end/js/slick.js')}}"></script>
...
<script src="{{asset('public/front-end/js/map-script.js')}}"></script>
<script src="{{asseT('public/front-end/js/mixitup.js')}}"></script>
<script src="{{asseT('public/front-end/js/script.js')}}"></script>
