<div class="sticky-header">
    <div class="auto-container clearfix">
        ...
        <div class="logo pull-left">
            {{-- <a href="index.html" class="img-responsive"><img src="{{asset('public/front-end/images/v.png')}}" alt="scroll logo" width="80px" title=""></a> --}}
        </div>
                ...
                <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent1">
                    <ul class="navigation clearfix">
                        ...
                        <li class="dropdown"><a>{{__('fl.Services')}}</a>
                            <ul>
                                <li><a href="{{ route('front.corporate-services') }}">{{__('fl.Corporate Services')}}</a></li>
                                <li><a href="{{ route('front.retail-services') }}">{{__('fl.Retail Services')}}</a></li>
                                <li><a href="{{ route('front.our-clients') }}">{{__('fl.Our Clients')}}</a></li>
                                <li><a href="{{ route('front.our-projects') }}">{{__('fl.Our Projects')}}</a></li>
                                
                            </ul>
                        </li>
                        <li class="dropdown"><a>{{ __('fl.Properties') }}</a>
                            <ul>
                               <li><a href="{{ route('front.property.index') }}">{{ __('fl.All Properties') }}</a>
                                </li>
                                @auth
                                    <li><a
                        ...
                        <li class="dropdown"><a>{{__('fl.Products')}}</a>
                            ...
                            <ul>
                                @foreach ($cats as $item)
                                    <li><a href="{{ route('front.category.products', $item->id) }}">{{ $item->name }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </li>
                        <li class="dropdown"><a>{{__('fl.Our Policies')}}</a>
                            <ul>
                                <li><a href="{{ url('/enivromental-policy') }}">{{__('fl.Environmental Policy')}}</a></li>
                                <li><a href="{{ route('front.health-safety-policy') }}">{{__('fl.Health Safety Policy')}}</a></li>
                    ...
                    @endauth
                    @auth
                        <li><a href="{{ route('front.employee-dashboard') }}">Dashboard</a></li>
                    @endauth
                    </ul>
                </div>
            </nav><!-- Main Menu End-->
