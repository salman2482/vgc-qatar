                ...
                <td align="center">
                    <table class="table-3" border="0" width="100%" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                            <tr>
                                <td class="td-1">
                                    {{-- <p>RFQ For "<strong>{{ $data['vgc']->category }}</strong>" Has Been
                                        {{ $data['vgc']->status }}</p> --}}
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table class="table-gray" cellpadding="5">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-2">{{ $data['user']->email ?? '' }}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Category</strong></td>
                                                <td class="td-2">{{ $data['vgc']->category }}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Status</strong></td>
                                                <td class="td-2">{{ $data['vgc']->status }}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>RFQ-REF</strong></td>
                                                <td class="td-2">{{ $data['rfq']->rfq_ref }}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Priority</strong></td>
                                                <td class="td-2">{{ $data['rfq']->priority }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
