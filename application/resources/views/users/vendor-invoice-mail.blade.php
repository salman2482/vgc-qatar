                ...
                <td align="center">
                    <table class="table-2" width="100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td align="center">
                                    <h1>INVOICE FOR {{ $invoice->lpo_ref }}</h1>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                <td class="td-1">
                                    <table class="table-gray" cellpadding="5">
                                        <tbody>
                                            <tr>
                                                <td class="td-1"><strong>INVOICE-REF</strong></td>
                                                <td class="td-2">{{ $invoice->invoice_ref_no ?? '' }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-2">{{ $invoice->user->email ?? '' }}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>QTN-REF</strong></td>
                                                <td class="td-2">{{ $invoice->qtn_ref ?? 'Not Found'?? '' }}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Category</strong></td>
                                                <td class="td-2">{{ $invoice->category ?? 'Not Found'}}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Total Value</strong></td>
                                                <td class="td-2">{{ $invoice->total_value ?? 'Not Found'}}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Status</strong></td>
                                                <td class="td-2">{{ $invoice->status ?? 'Not Found'}}</td>
                                            </tr>
                                            @if ( $invoice->status =='Request For Amendment')
                                            <tr>
                                                <td class="td-1"><strong>Reason</strong></td>
                                                <td class="td-2">{{ $invoice->reason ?? 'Not Found'}}</td>
                                            </tr>
                                            @endif
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="td-1">
                                                    ...
                                                    Thank you for availing our service/s. Please find attached copy of the Invoice for your reference. 
                                                    <br>
                                                    Our team will be coordinating with you soon for further details.
                                                    <br><br>
                                                    Best Regards,
                                                    <br>
                                                    Veteran
