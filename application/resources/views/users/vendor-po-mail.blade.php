                ...
                <td align="center">
                    <table class="table-2" width="100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td align="center">
                                    <h1>PO RESPONSE TO {{ $vendorpo->qtn_ref_no }}</h1>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                <td class="td-1">
                                    <table class="table-gray" cellpadding="5">
                                        <tbody>
                                            <tr>
                                                <td class="td-1"><strong>PO-REF</strong></td>
                                                <td class="td-2">{{ $vendorpo->po_ref ?? '' }}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Vendor Name</strong></td>
                                                <td class="td-2">
                                                    {{ $vendorpo->user->first_name ?? '' }} 
                                                    {{ $vendorpo->user->last_name ?? '' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Vendor Email</strong></td>
                                                <td class="td-2">{{ $vendorpo->user->email ?? '' }}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Issuing Date</strong></td>
                                                <td class="td-2">{{ $vendorpo->issuing_date ?? 'Not Found'?? '' }}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Category</strong></td>
                                                <td class="td-2">{{ $vendorpo->category ?? 'Not Found'}}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>QTN-REF-NO</strong></td>
                                                <td class="td-2">{{ $vendorpo->qtn_ref_no ?? 'Not Found'}}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Total Value</strong></td>
                                                <td class="td-2">{{ $vendorpo->total_value ?? 'Not Found'}}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Payment Method</strong></td>
                                                <td class="td-2">{{ $vendorpo->payment_method ?? 'Not Found'}}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Terms Condition</strong></td>
                                                <td class="td-2">{{ $vendorpo->terms_condition ?? 'Not Found'}}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
