...
<body class="pdf-page">
    ...
    <div class="bill-pdf {{ config('css.bill_mode') }} {{ @page['bill_mode'] }}" style="width: 100%">
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td class="x-mid">
                            <div class="x-bill-type" style="margin-left: -212px;">
                                <h1><strong>REQUEST FOR QUOTATION</strong></h1>
                            </div>
                        </td>
                    </tr>
                </tbody>
        ...
        <div style="text-align: center; font-size: 18px; font-family: Montserrat, sans-serif !important; font-weight: 600;">
            <h6>
                This is with reference to the abovementioned subject, we are kindly requesting you to provide your best proposal/quotation on the below requirement. Your Early response is highly appreciated.
            </h6>
        </div>
        <div class="col-12">
