                ...
                <td align="center">
                    <table class="table-2" width="100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td align="center">
                                    <h1>QUOTATION FOR {{ $quotation->rfq_ref }}</h1>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                                    ...
                                    <table class="table-gray" cellpadding="5">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-2">{{ $quotation->user->email ?? '' }}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Category</strong></td>
                                                <td class="td-2">{{ $quotation->category }}</td>
                                            </tr>
                                            
                                            <tr>
                                                <td class="td-1"><strong>RFQ-REF</strong></td>
                                                <td class="td-2">{{ $quotation->rfq_ref }}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Total Value</strong></td>
                                                <td class="td-2">{{ $quotation->total_value }}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Receiving Date</strong></td>
                                                <td class="td-2">{{ $quotation->receiving_date }}</td>
                                            </tr>
                                            <tr>
                                                <td class="td-1"><strong>Devlivery Time</strong></td>
                                                <td class="td-2">{{ $quotation->devlivery_time }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
