                ...
                <td align="center">
                    <table class="table-2" width="100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td align="left">
                                    <h1>Dear Valued {{ $data['first_name'] ?? '' }} {{ $data['last_name'] ?? '' }},
                                    </h1>
                                </td>
                            </tr>
                        </tbody>
                            ...
                            <tr>
                                <td class="td-1">
                                    ...
                                    @if ($data['status'] == 'active')
                                        <p>
                                            Thank you for your registration on our Vendor’s Portal. 
                                        </p>
                                        <p>
                                            We are happy to welcome you to Veteran Approved Vendors List. Please logo in into your vendor portal, where you can have full access to all your business related inquiries and all business transaction between our company and your respected organisation.
                                        </p>
                                    @elseif($data['status'] == 'suspended')
                                        <p> 
                                            Thank you for your registration on our Vendor’s List. Please be informed that your Account had been suspended due to reasons being defined by our Procurement Team.
                                        <p>
                                        <p>
                                    ...
                                    @else
                                        <p>
                                            Thank you for your registration on our Vendor’s Portal. However, we regret to inform you that your application is rejected due to reasons being defined by our Procurement Team.
                                        </p>
                                        <p>
