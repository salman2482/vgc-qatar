...
class FilePermissions {
    ...
    public function check($action = '', $file = '') {
        ...
        //failed
        Log::error("permissions denied on this file", ['process' => '[permissions][files]', config('app.debug_ref'), 'function' => __function__, 'file' => basename(__FILE__), 'line' => __line__, 'path' => __file__]);
        return false;
    }
