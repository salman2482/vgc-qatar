...
class CommentPermissions {
    ...
    public function check($action = '', $comment = '') {
        ...
        //failed
        Log::error("permissions denied on this comment", ['process' => '[permissions][comments]', config('app.debug_ref'), 'function' => __function__, 'comment' => basename(__FILE__), 'line' => __line__, 'path' => __file__]);
        return false;
    }
