...
class AttachmentPermissions {
    ...
    public function check($action = '', $attachment = '') {
        ...
        //failed
        Log::error("permissions denied on this attachment", ['process' => '[permissions][attachments]', config('app.debug_ref'), 'function' => __function__, 'attachment' => basename(__FILE__), 'line' => __line__, 'path' => __file__]);
        return false;
    }
