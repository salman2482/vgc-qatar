...
class ChecklistPermissions {
    ...
    public function check($action = '', $checklist = '') {
        ...
        //failed
        Log::error("permissions denied on this checklist", ['process' => '[permissions][checklists]', config('app.debug_ref'), 'function' => __function__, 'checklist' => basename(__FILE__), 'line' => __line__, 'path' => __file__]);
        return false;
    }
