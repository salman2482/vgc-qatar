...
class Client extends Model {
     ...
     */
    public function rfm() {
        return $this->belongsTo('App\Models\Rfm', 'inline_manager_id', 'hoc_id');
    }
    /**
     * relatioship business rules:
    ...
    /**
     * Get all of the contractsMgt for the Client
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function contractsMgt(): HasMany
    {
        return $this->hasMany(ContractMgt::class, 'client_id');
    }
}
