...
class User extends Authenticatable
{
    ...
    public function fvendor()
    {
        return $this->hasOne('App\FrontVendorRegistration');
    }

    public function eachrfq()
    {
        return $this->hasOne('App\EachRfq');
    }

    public function qtn()
    {
        return $this->hasOne('App\VendorQuotation');
    }

    public function vendorpo()
    {
        return $this->hasOne('App\VendorPo');
    }

    public function fvendorinvoice()
    {
        return $this->hasOne('App\VendorInvoice');
    }

    /**
     * Get all of the frontEndProperties for the User
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function frontEndProperties(): HasMany
    {
        return $this->hasMany(FrontEndProperty::class);
    }

    /**
     * Get the frontuser associated with the User
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne
     */
    public function frontuser(): HasOne
    {
