...
class DestroyRepository {
    ...
    public function destroyProperty($id) {
        ...
        //validate property
        if (!is_numeric($id)) {
            Log::error("validation error - invalid params", ['process' => '[PropertyRepository]', config('app.debug_ref'), 'function' => __function__, 'file' => basename(__FILE__), 'line' => __line__, 'path' => __file__]);
            return false;
        }

        //get property and validate
        if (!$property = \App\Property::Where('id', $id)->first()) {
            Log::error("record could not be found", ['process' => '[PropertyRepository]', config('app.debug_ref'), 'function' => __function__, 'file' => basename(__FILE__), 'line' => __line__, 'path' => __file__]);
            return false;
        }
