...
class RecurringInvoiceRepository {
     ...
     */
    public function processInvoices($limit = 10) {
    ...
    private function getInvoices($limit) {
        ...
        Log::info("searching for invoices that are due for renewal today", ['process' => '[recurring-invoices-cronjob]', config('app.debug_ref'), 'function' => __function__, 'file' => basename(__FILE__), 'line' => __line__, 'path' => __file__]);
        ...
        $invoices->where('bill_cron_status', 'none');
