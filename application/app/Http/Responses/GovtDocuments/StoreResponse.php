...
class StoreResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('show_after_adding') == 'on') {
            ...
            if ($count == 1) {
                $html = view('pages/govtdocument/components/table/table', compact('govtdocuments'))->render();
                $jsondata['dom_html'][] = array(
                    'selector' => '#govtdocuments-table-wrapper',
                    'action' => 'replace',
                    'value' => $html);
            } else {
                ...
                $jsondata['dom_html'][] = array(
                    'selector' => '#govtdocuments-td-container',
                    'action' => 'prepend',
                    'value' => $html);
            }
