...
namespace App\Http\Responses\Quotations;
...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/quotation/components/table/ajax';
                $dom_container = '#quotations-td-container';
                $dom_action = 'append';
                break;
            ...
            case 'search':
                $template = 'pages/quotation/components/table/table';
                $dom_container = '#quotations-table-wrapper';
                $dom_action = 'replace-with';
                break;

            //template and dom - for ajax initial loading
            default:
                $template = 'pages/quotation/tabswrapper';
            ...
            //     $url = loadMoreButtonUrl($properties->currentPage() + 1, request('source'));
            ...
            $html = view($template, compact('page', 'quotations'))->render();
            ...
            $jsondata['dom_html'][] = [
                ...
                'action' => 'replace',
                'value' => strtoupper(__('Quotations')),
            ];
            ...
            //standard view
            $page['url'] = loadMoreButtonUrl($quotations->currentPage() + 1, request('source'));
            $page['loading_target'] = 'quotations-td-container';
            $page['visibility_show_load_more'] = ($quotations->currentPage() < $quotations->lastPage()) ? true : false;
            return view('pages/quotation/wrapper', compact('page', 'quotations'))->render();
        }
