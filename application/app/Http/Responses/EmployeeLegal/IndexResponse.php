...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/employeedocs/components/table/ajax';
                $dom_container = '#employeedocss-td-container';
                $dom_action = 'append';
                break;
            ...
            case 'sort':
                $template = 'pages/employeedocs/components/table/ajax';
                $dom_container = '#employees-td-container';
                $dom_action = 'replace';
                break;

            //from search box or filter panel
            case 'search':
                $template = 'pages/employeedocs/components/table/table';
                $dom_container = '#employees-table-wrapper';
                $dom_action = 'replace-with';
                break;

            //template and dom - for ajax initial loading
            default:
                $template = 'pages/employeedocs/tabswrapper';
            ...
            $html = view($template, compact('page', 'employees'))->render();
            ...
            $jsondata['dom_html'][] = [
                ...
                'action' => 'replace',
                'value' => strtoupper(__('Employee Legal Documents')),
            ];
            ...
            $jsondata['dom_classes'][] = [
                'selector' => '#tabs-menu-employeelegal',
                'action' => 'add',
                'value' => 'active',
            ];
            ...
            $page['loading_target'] = 'employees-td-container';
            $page['visibility_show_load_more'] = ($employees->currentPage() < $employees->lastPage()) ? true : false;
            return view('pages/employeedocs/wrapper', compact('page', 'employees'))->render();
        }
