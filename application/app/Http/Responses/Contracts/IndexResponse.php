...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/contract/components/table/ajax';
            ...
            case 'search':
                $template = 'pages/contract/components/table/table';
            ...
            default:
                $template = 'pages/contract/tabswrapper';
            ...
            $html = view($template, compact('page', 'contracts'))->render();
            ...
            return view('pages/contract/wrapper', compact('page', 'contracts'))->render();
        }
