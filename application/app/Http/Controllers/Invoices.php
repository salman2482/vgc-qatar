...
class Invoices extends Controller {
    ...
    {
        $invoice = DB::table('invoices')->where('bill_invoiceid', $id)->update(['bill_status' => 'Accepted']);
        return back();
    }

    public function authenticateInvoice($id)
    {
        $invoice = DB::table('invoices')->where('bill_invoiceid', $id)->update(['bill_status' => 'paid']);
        return back();
    }

    public function downloadInvoice($id)
    {
        $attachment = \App\Models\Attachment::Where('attachmentresource_id', $id)->first();
