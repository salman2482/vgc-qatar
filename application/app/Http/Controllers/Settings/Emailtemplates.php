...
class Emailtemplates extends Controller {
    ...
    public function index()
    {
        ...
        $other = \App\Models\EmailTemplate::Where('emailtemplate_category', 'other')->get();
        $estimates = \App\Models\EmailTemplate::Where('emailtemplate_category', 'estimates')->get();
        $employee = \App\Models\EmailTemplate::where('emailtemplate_category', 'employee')->first();
        $user_email = \App\Models\EmailTemplate::where('emailtemplate_category', 'user')->first();
        $admin = \App\Models\EmailTemplate::where('emailtemplate_category', 'admin')->first();
