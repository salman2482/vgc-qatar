...
class Kernel extends HttpKernel {
    ...
    protected $routeMiddleware = [
        ...
        'auth.basic' => \Illuminate\Auth\Middleware\AuthenticateWithBasicAuth::class,
                'frontVendorMiddleware' => \App\Http\Middleware\FrontVendorMiddleware::class,
        ...
        //[growcrm] - [properties]
        'propertiesMiddlewareIndex' => \App\Http\Middleware\Properties\Index::class,
        'propertiesMiddlewareCreate' => \App\Http\Middleware\Properties\Create::class,

        //[growcrm] - [rfms]
        'rfmsMiddlewareIndex' => \App\Http\Middleware\Rfms\Index::class,
        //[growcrm] - [rfms]
        'materialsMiddleware' => \App\Http\Middleware\Materials\MaterialsMiddleware::class,

        //[growcrm] - [documents]
        'documentsMiddlewareIndex' => \App\Http\Middleware\Documents\Index::class,
        //[growcrm] - [employeedocument]
        'employeeMiddlewareIndex' => \App\Http\Middleware\EmployeeDocument\Index::class,

        //[growcrm] - [quotations]
        'quotationsMiddlewareIndex' => \App\Http\Middleware\Quotations\Index::class,
        //[growcrm] - [quotations]
        'servicessMiddlewareIndex' => \App\Http\Middleware\Services\Index::class,

        //[growcrm] - [Lpos]
        'lposMiddlewareIndex' => \App\Http\Middleware\Lpos\Index::class,

        //[growcrm] - [govtdocs]
        'govtdocsMiddlewareIndex' => \App\Http\Middleware\GovtDocs\Index::class,

        //[growcrm] - [contracts]
        'contractsMiddlewareIndex' => \App\Http\Middleware\ContractsMgt\Index::class,


        //[growcrm] - [vendorrfq]
        'vendorrfqMiddlewareIndex' => \App\Http\Middleware\VendorRfq\Index::class,

        //[growcrm] - [vendorqtn]
        'vendorqtnMiddlewareIndex' => \App\Http\Middleware\VendorQtn\Index::class,

        //[growcrm] - [vendorpo]
        'vendorpoMiddlewareIndex' => \App\Http\Middleware\VendorPo\Index::class,

        //[growcrm] - [vendorinvoice]
        'vendorinvoiceMiddlewareIndex' => \App\Http\Middleware\VendorInvoice\Index::class,

        //[growcrm] - [frontclientproject]
        'frontclientprojectMiddlewareIndex' => \App\Http\Middleware\FrontClientProject\Index::class,
