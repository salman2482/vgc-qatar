...
function NXBootCards() {
  ...
  if ($("#cardModal").length) {
    ...
    //post comment
    $(document)
      .off("click", "#card-comment-post-button")
      .on("click", "#card-comment-post-button", function (e) {
        $("#card-comment-tinmyce-container").hide();
        $("#card-coment-placeholder-input-container").show();
  ...
  if ($("#cardModal").length) {
    ...
    $(document)
      .off("click", ".js-description-save")
      .on("click", ".js-description-save", function () {
        NX.card_description_input.val(NX.card_description.html());
        NX.card_description.removeClass("card-tinymce-textarea");
        NX.card_description_submit.hide();
        NX.card_description_edit.show();
        tinymce.remove("#card-description-container");
        $("#card-description-container").html(
          '<div class="loading w-px-150 h-px-30"></div>'
        );
        nxAjaxUxRequest($(this));
      });
  }
  ...
  if ($("#cardModal").length) {
    ...
    $(".card-pickadate").on("changeDate", function (e) {
      //update form date
      $("#" + $(this).attr("data-hidden-field")).val(
        moment(e.date).format("YYYY-MM-DD")
      );
      //update value
      $("#" + $(this).attr("data-container")).html(
        moment(e.date).format(NX.date_moment_format)
      );
      //send request
      nxAjaxUxRequest($(this));
    });
    ...
    $(document).on(
      "click",
      "#card-left-panel, .js-card-settings-button, .card-pickadate",
      function () {
    ...
    $(document).on(
      "click",
      "#card-leads-left-panel, .js-card-settings-button, .card-pickadate",
      function () {
        $(".js-card-settings-button-static").popover("hide");
      }
    );
     ...
     * -------------------------------------------------- */
    $(document)
      .find(".js-card-settings-button-static")
      .each(function () {
        $(this).popover({
          html: true,
          sanitize: false, //The HTML is NOT user generated
     ...
     * ------------------------------------------------------------*/
    $(document)
      .off("click", ".card-tasks-update-status-link")
      .on("click", ".card-tasks-update-status-link", function () {
        ...
        $(".popover-body")
          .find("#current_task_status_text")
          .val($card_display_element.html());
        //add loading
     ...
     * ------------------------------------------------------------*/
    $(document)
      .off("click", ".card-tasks-update-priority-link")
      .on("click", ".card-tasks-update-priority-link", function () {
        //update the buttons parent popover
        $(this).attr("data-form-id", $(this).closest(".popover").attr("id"));
        //cart display element
        ...
        //set current value text
        $(".popover-body")
          .find("#current_task_priority_text")
          .val($card_display_element.html());
        //add loading
        $card_display_element.html("---");
        $card_display_element.attr("data-value", "");
     ...
     * ------------------------------------------------------------*/
    $(document)
      .off("click", ".card-tasks-update-visibility-link")
      .on("click", ".card-tasks-update-visibility-link", function () {
        //update the buttons parent popover
        $(this).attr("data-form-id", $(this).closest(".popover").attr("id"));
        //cart display element
        ...
        //set current value text
        $(".popover-body")
          .find("#current_task_client_visibility_text")
          .val($card_display_element.html());
        //add loading
        $card_display_element.html("---");
        $card_display_element.attr("data-value", "");
     ...
     * ------------------------------------------------------------*/
    $(document)
      .off("click", "#card-tasks-update-milestone-button")
      .on("click", "#card-tasks-update-milestone-button", function () {
        //update the buttons parent popover
        $(this).attr("data-form-id", $(this).closest(".popover").attr("id"));
        //get selected text
     ...
     * ------------------------------------------------------------*/
    $(document)
      .off("click", "#card-lead-name")
      .on("click", "#card-lead-name", function () {
        //update names in the form
        $(".popover-body")
          .find("#lead_firstname")
          .val($(document).find("#card-lead-firstname-containter").html());
        $(".popover-body")
          .find("#lead_lastname")
          .val($(document).find("#card-lead-lastname-containter").html());
      });
    $(document)
      .off("click", "#card-leads-update-name-button")
      .on("click", "#card-leads-update-name-button", function () {
        //update the buttons parent popover
        $(this).attr("data-form-id", $(this).closest(".popover").attr("id"));
        //reset current name
     ...
     * ------------------------------------------------------------*/
    $(document)
      .off("click", "#card-lead-value")
      .on("click", "#card-lead-value", function () {
        $(".popover-body").find("#lead_value").val($(this).attr("data-value"));
      });
    $(document)
      .off("click", "#card-leads-update-value-button")
      .on("click", "#card-leads-update-value-button", function () {
        //update the buttons parent popover
        $(this).attr("data-form-id", $(this).closest(".popover").attr("id"));
     ...
     * ------------------------------------------------------------*/
    $(document)
      .off("click", "#card-leads-update-status-button")
      .on("click", "#card-leads-update-status-button", function () {
        //update the buttons parent popover
        $(this).attr("data-form-id", $(this).closest(".popover").attr("id"));
        //reset data & add loading class
     ...
     * ------------------------------------------------------------*/
    $(document)
      .off("click", "#card-leads-update-category-button")
      .on("click", "#card-leads-update-category-button", function () {
        //update the buttons parent popover
        $(this).attr("data-form-id", $(this).closest(".popover").attr("id"));
        //reset data & add loading class
        ...
        //current text value
        $(".popover-body")
          .find("#current_lead_category_text")
          .val($card_display_element.html());
        $card_display_element.html("---");
        $card_display_element.attr("data-value", "");
        $card_display_element.addClass("loading");
     ...
     * ------------------------------------------------------------*/
    $(document)
      .off("click", "#card-lead-phone")
      .on("click", "#card-lead-phone", function () {
        var current_value = $(this).html() == "---" ? "" : $(this).html();
        $(".popover-body").find("#lead_phone").val(current_value);
      });
    $(document)
      .off("click", "#card-leads-update-phone-button")
      .on("click", "#card-leads-update-phone-button", function () {
        //update the buttons parent popover
        $(this).attr("data-form-id", $(this).closest(".popover").attr("id"));
        //reset data & add loading class
     ...
     * ------------------------------------------------------------*/
    $(document)
      .off("click", "#card-lead-email")
      .on("click", "#card-lead-email", function () {
        var current_value = $(this).html() == "---" ? "" : $(this).html();
        $(".popover-body").find("#lead_email").val(current_value);
      });
    $(document)
      .off("click", "#card-leads-update-email-button")
      .on("click", "#card-leads-update-email-button", function () {
        //update the buttons parent popover
        $(this).attr("data-form-id", $(this).closest(".popover").attr("id"));
        //reset data & add loading class
     ...
     * ------------------------------------------------------------*/
    $(document)
      .off("click", "#card-leads-update-source-button")
      .on("click", "#card-leads-update-source-button", function () {
        //update the buttons parent popover
        $(this).attr("data-form-id", $(this).closest(".popover").attr("id"));
        //reset data & add loading class
     ...
     * ------------------------------------------------------------*/
    $(document)
      .off("click", "#card-tasks-update-assigned")
      .on("click", "#card-tasks-update-assigned", function () {
        //update the buttons parent popover
        $(this).attr("data-form-id", $(this).closest(".popover").attr("id"));
        //add loading class
     ...
     * ------------------------------------------------------------*/
    $(document)
      .off("click", "#card-leads-update-assigned")
      .on("click", "#card-leads-update-assigned", function () {
        //update the buttons parent popover
        $(this).attr("data-form-id", $(this).closest(".popover").attr("id"));
        //add loading class
     ...
     * ------------------------------------------------------------*/
    $(document)
      .off("click", "#js-card-toggle-fileupload")
      .on("click", "#js-card-toggle-fileupload", function () {
        ...
        init: function () {
          this.on("error", function (file, message, xhr) {
            ...
            if (
              ...
              if (
                typeof error === "object" &&
                typeof error.notification != "undefined"
              ) {
...
function NXPostGeneralComment() {
  ...
  $(document).on(
    "click",
    "#placeholder-container-" + unique_comment_id,
    function () {
...
function NXContacts() {
  $("#commonModalForm").validate().destroy();
   ...
   //uplaod files
  $("#fileupload_employee_receipt").dropzone({
      url: "/fileupload",
      headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      },
      ...
      success: function(file, response) {
          ...
          $preview.append('<input type="hidden" name="employee[' + response.uniqueid +
              ']"  value="' + response.filename + '">');
          $preview.append('<input type="hidden" name="attachment_unique_employee"  value="employee">');
      }
  });
  
  
  
  $("#client_signature").dropzone({
    url: "/fileupload",
    headers: {
      "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
    },
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="client_stamp_attachment[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_client_stamp" value="client_stamp">'
      );
    },
  });
  $("#commonModalForm").validate({
...
function NXEstimates() {
  //variable
  var expense_modal_trigger_clients_project_list = $(
    "#js-trigger-expenses"
  ).attr("data-payload");
 ...
 * -------------------------------------------------------------------------------------*/
function NXAddEditService() {
  //uplaod files
  $("#service_image").dropzone({
    url: "/fileupload",
    headers: {
      "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
    },
    ...
    success: function (file, response) {
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_service_image" value="service_image">'
      );
    },
  });
...
function NXAddEditContract() {
  ...
  $("#fileupload_contracts_lpo_copy").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="lpo_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_lpo" value="lpo">'
      );
    },
  });
  // contract upload
  $("#fileupload_contract_copy").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="contract_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_contract" value="contract">'
      );
    },
  });
...
function NXAddEditQuotation() {
  ...
  $("#transmital_copy").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="transmital_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_transmital_copy" value="transmital_copy">'
      );
    },
  });
  $("#technical_copy").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="technical_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_technical_copy" value="technical_copy">'
      );
    },
  });
  $("#financial_copy").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="financial_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_financial_copy" value="financial_copy">'
      );
    },
  });
...
function NXAddEditLpo() {
  ...
  $("#lpo_rfm_copy").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="lpo_rfm_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_lpo_rfm_copy" value="lpo_rfm_copy">'
      );
    },
  });
  $("#lpo_lpo_copy").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="lpo_lpo_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_lpo_lpo_copy" value="lpo_lpo_copy">'
      );
    },
  });
...
function NXClientUploadLogo() {
  if ($("#js-trigger-clients-modal-upload-logo").length) {
    var client_id = $("#js-trigger-clients-modal-upload-logo").attr(
      "data-payload"
    );
    ...
    $("#fileupload_single_image").dropzone({
      ...
      success: function (file, response) {
        ...
        //create a hidden form field for this file
        $preview.append(
          '<input type="hidden" name="logo_filename"  value="' +
            response.filename +
            '">'
        );
        $preview.append(
          '<input type="hidden" name="logo_directory"  value="' +
            response.uniqueid +
            '">'
        );
        $preview.append(
  ...
  if ($("#admin-dhasboard-income-vs-expenses").length) {
    var chart = new Chartist.Line(
      ".incomeexpenses",
      {
        ...
        series: [NX.admin_home_chart_income, NX.admin_home_chart_expenses],
      },
      {
...
function NXANavTeam() {
  ...
  $(".menu-tooltip").tooltip({
    ...
    placement: "right",
    template:
      '<div class="tooltip menu-tooltips" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>',
  });
 ...
 * -------------------------------------------------------------------------------------*/
function NXVrfqDetails() {
  //editor variables
  NX.vrfq_description = $("#vrfq-description");
  NX.vrfq_description_original_text = $("#vrfq-description").html();
  NX.vrfq_descrition_selector = "#vrfq-description";
  NX.vrfq_description_submit = $("#vrfq-description-submit");
  NX.vrfq_description_edit = $("#vrfq-description-edit");
  NX.vrfq_description_height = $("#vrfq-description").outerHeight();
  NX.vrfq_details_tags_edit = $("#vrfq-details-edit-tags");
  NX.vrfq_details_tags = $("#vrfq-details-tags");

  //edit button clicked
  $(document).on("click", "#vrfq-description-button-edit", function () {
    NX.vrfq_description_edit.hide();
    NX.vrfq_description.addClass("tinymce-textarea");
    NX.vrfq_details_tags.hide();
    NX.vrfq_details_tags_edit.show();
    NX.vrfq_description_submit.show();
    nxTinyMCEBasic(NX.vrfq_description_height, NX.vrfq_descrition_selector);
  });

  //cancel button clicked
  $(document).on("click", "#vrfq-description-button-cancel", function () {
    NX.vrfq_description.removeClass("tinymce-textarea");
    NX.vrfq_description_submit.hide();
    NX.vrfq_description_edit.show();
    NX.vrfq_details_tags.show();
    NX.vrfq_details_tags_edit.hide();
    NX.vrfq_description.html(NX.vrfq_description_original_text);
    tinymce.remove();
  });
  //save button clicked
  $(document).on("click", "#vrfq-description-button-save", function () {
    try {
      $("#description").val(tinymce.activeEditor.getContent());
    } catch (err) {}
    //unbind events
    $(this).off("click");
    $("#vrfq-description-button-edit").off("click");
    $("#vrfq-description-button-cancel").off("click");
    //make request
    nxAjaxUxRequest($(this));
    tinymce.remove();
  });
...
/**--------------------------------------------------------------------------------------
 * [vrfq - DYNAMIC]
 * @description: show dynamic vrfq pages
 * -------------------------------------------------------------------------------------*/
if ($("#dynamic-vrfq-content").length) {
  nxAjaxUxRequest($("#dynamic-vrfq-content"));
}
...
function NXAddEditProject() {
  ...
  var project_progress_display = document.getElementById(
    "edit_project_progress_display"
  );
   ...
   * ---------------------------------------------------------*/
  $("#clientperm_tasks_create, #clientperm_tasks_collaborate").on(
    "change",
    function () {
      if ($(this).is(":checked")) {
  ...
  $(document).on("click", "#commonModalSubmitButton", function () {
    if ($("#project_billing_rate").length) {
      ...
      $("#project_billing_rate").val(
        project_billing_rate.replace(/[^0-9.]/g, "")
      );
    }
  });
 ...
 * @description: edit projects modal
 * -------------------------------------------------------------------------------------*/
function NXAddEditVrfq() {
  //page section
  var page_section = $("#js-vrfqs-modal-add-edit").attr("data-section");

  //reset editor
  nxTinyMCEBasic();

  //progress slider
  var progress = document.getElementById("edit_vrfq_progress_bar");
  noUiSlider.create(progress, {
    start: [NX.varInitialVrfqProgress],
    connect: true,
    step: 1,
    range: {
      min: 0,
  ...
  //set display and hidden form field values
  var vrfq_progress_input = document.getElementById("vrfq_progress");
  var vrfq_progress_display = document.getElementById(
    "edit_vrfq_progress_display"
  );
  progress.noUiSlider.on("update", function (values, handle) {
    vrfq_progress_display.innerHTML = values[handle];
    vrfq_progress_input.value = values[handle];
  });

  /** ----------------------------------------------------------
   * create vrfq - form validation
   * ---------------------------------------------------------*/
  if (page_section == "create") {
    $("#commonModalForm").validate().destroy();
    $("#commonModalForm").validate({
      rules: {
        vrfq_rfq_ref: "required",
        vrfq_priority: "required",
        vrfq_due_date_request: "required",
        vrfq_sn: "required",
        vrfq_description: "required",
        vrfq_uom: "required",
        vrfq_qty: "required",
      },
      submitHandler: function (form) {
...
function NXProjectDetails() {
  ...
  $(document).on("click", "#project-description-button-edit", function () {
    ...
    nxTinyMCEBasic(
      NX.project_description_height,
      NX.project_descrition_selector
    );
  });
 ...
 * @description: edit projects modal
 * -------------------------------------------------------------------------------------*/
function NXAddEditFrontProject() {

    //page section
    var page_section = $("#js-frontprojects-modal-add-edit").attr('data-section');

    //reset editor
    nxTinyMCEBasic();

    //uplaod files
    $("#fileupload_frontproj_receipt").dropzone({
        url: "/fileupload",
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        ...
        success: function(file, response) {
            ...
            var $preview = $(file.previewElement);
            //create a hidden form field for this file
            $preview.append('<input type="hidden" name="frontproject[' + response.uniqueid +
                ']"  value="' + response.filename + '">');
            $preview.append('<input type="hidden" name="attachment_unique_input_document"  value="frontproject">');
        }
    });
    /** ----------------------------------------------------------
     * create frontproject - form validation
     * ---------------------------------------------------------*/
    if (page_section == 'create') {
        $("#commonModalForm").validate().destroy();
        $("#commonModalForm").validate({
            rules: {
                frontproject_title: "required",
                frontproject_contractor: "required",
                frontproject_client: "required",
                frontproject_status: "required",
            },
            submitHandler: function(form) {
                //ajax form, so initiate ajax request here
                nxAjaxUxRequest($("#commonModalSubmitButton"));
    ...
    /** ----------------------------------------------------------
     * edit frontproject - form validation
     * ---------------------------------------------------------*/
    if (page_section == 'edit') {
        $("#commonModalForm").validate().destroy();
        $("#commonModalForm").validate({
...
/**--------------------------------------------------------------------------------------
 * corporateservice - MODAL] 
 * @description: edit projects modal
 * -------------------------------------------------------------------------------------*/
 function NXAddEditCorporateService() {

  //page section
  var page_section = $("#js-corporateservices-modal-add-edit").attr('data-section');

  //reset editor
  nxTinyMCEBasic();

  //uplaod files
  $("#fileupload_corporateservice_receipt").dropzone({
      url: "/fileupload",
      headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      },
      ...
      success: function(file, response) {
          ...
          var $preview = $(file.previewElement);
          //create a hidden form field for this file
          $preview.append('<input type="hidden" name="corporateservice[' + response.uniqueid +
              ']"  value="' + response.filename + '">');
          $preview.append('<input type="hidden" name="attachment_unique_corporateservice"  value="corporateservice">');
      }
  });
  /** ----------------------------------------------------------
   * create corporateservice - form validation
   * ---------------------------------------------------------*/
  if (page_section == 'create') {
      $("#commonModalForm").validate().destroy();
      $("#commonModalForm").validate({
          rules: {
              corporateservice_title: "required",
              corporateservice_description: "required",
  ...
  /** ----------------------------------------------------------
   * edit corporateservice - form validation
   * ---------------------------------------------------------*/
  if (page_section == 'edit') {
      $("#commonModalForm").validate().destroy();
      $("#commonModalForm").validate({
   ...
   * select2 firefox fix
   * ---------------------------------------------------------*/
  $('#corporateservice_clientid').select2({
      dropdownParent: $('#commonModal')
  });
}
 ...
 * @description: edit projects modal
 * -------------------------------------------------------------------------------------*/
 function NXAddEditSubCorporateService() {

  //page section
  var page_section = $("#js-subcorporateservices-modal-add-edit").attr('data-section');

  //reset editor
  nxTinyMCEBasic();

  //uplaod files
  $("#subfileupload_subcorporateservice_receipt").dropzone({
      url: "/fileupload",
      headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      },
      ...
      success: function(file, response) {
          ...
          var $preview = $(file.previewElement);
          //create a hidden form field for this file
          $preview.append('<input type="hidden" name="subcorporateservice[' + response.uniqueid +
              ']"  value="' + response.filename + '">');
          $preview.append('<input type="hidden" name="attachment_unique_subcorporateservice"  value="subcorporateservice">');
      }
  });
  /** ----------------------------------------------------------
   * create subcorporateservice - form validation
   * ---------------------------------------------------------*/
  if (page_section == 'create') {
      $("#commonModalForm").validate().destroy();
      $("#commonModalForm").validate({
          rules: {
              subcorporateservice_title: "required",
              subcorporateservice_description: "required",
              subcorporateservice_corporate_service	: "required",
  ...
  /** ----------------------------------------------------------
   * edit subcorporateservice - form validation
   * ---------------------------------------------------------*/
  if (page_section == 'edit') {
      $("#commonModalForm").validate().destroy();
      $("#commonModalForm").validate({
   ...
   * select2 firefox fix
   * ---------------------------------------------------------*/
  $('#subcorporateservice_clientid').select2({
      dropdownParent: $('#commonModal')
  });
}
...
/**--------------------------------------------------------------------------------------
 * frontclient - MODAL] 
 * @description: edit clients modal
 * -------------------------------------------------------------------------------------*/
function NXAddEditFrontClient() {

    //page section
    var page_section = $("#js-frontclients-modal-add-edit").attr('data-section');

    //reset editor
    nxTinyMCEBasic();

    //uplaod files
    $("#fileupload_frontclient_receipt").dropzone({
        url: "/fileupload",
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        ...
        success: function(file, response) {
            ...
            var $preview = $(file.previewElement);
            //create a hidden form field for this file
            $preview.append('<input type="hidden" name="frontclient[' + response.uniqueid +
                ']"  value="' + response.filename + '">');
            $preview.append('<input type="hidden" name="attachment_unique_input_document"  value="frontclient">');
        }
    });
    /** ----------------------------------------------------------
     * create frontclient - form validation
     * ---------------------------------------------------------*/
    if (page_section == 'create') {
        $("#commonModalForm").validate().destroy();
        $("#commonModalForm").validate({
            rules: {
                frontclient_name: "required",
                frontclient_description: "required",
    ...
    /** ----------------------------------------------------------
     * edit frontclient - form validation
     * ---------------------------------------------------------*/
    if (page_section == 'edit') {
        $("#commonModalForm").validate().destroy();
        $("#commonModalForm").validate({
 ...
 * @description: edit clients modal
 * -------------------------------------------------------------------------------------*/
function NXAddEditFrontBanner() {

    //page section
    var page_section = $("#js-frontbanners-modal-add-edit").attr('data-section');

    //reset editor
    nxTinyMCEBasic();

    //uplaod files
    $("#fileupload_frontbanner_receipt").dropzone({
        url: "/fileupload",
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        ...
        success: function(file, response) {
            ...
            var $preview = $(file.previewElement);
            //create a hidden form field for this file
            $preview.append('<input type="hidden" name="frontbanner[' + response.uniqueid +
                ']"  value="' + response.filename + '">');
            $preview.append('<input type="hidden" name="attachment_unique_input_document"  value="frontbanner">');
        }
    });
    /** ----------------------------------------------------------
     * create frontbanner - form validation
     * ---------------------------------------------------------*/
    if (page_section == 'create') {
        $("#commonModalForm").validate().destroy();
        $("#commonModalForm").validate({
            rules: {
                frontbanner_title: "required",
                frontbanner_title_ar: "required",
                frontbanner_description: "required",
                frontbanner_description_ar: "required",
            },
            submitHandler: function(form) {
                //ajax form, so initiate ajax request here
                nxAjaxUxRequest($("#commonModalSubmitButton"));
    ...
    /** ----------------------------------------------------------
     * edit frontbanner - form validation
     * ---------------------------------------------------------*/
    if (page_section == 'edit') {
        $("#commonModalForm").validate().destroy();
        $("#commonModalForm").validate({
...
/**--------------------------------------------------------------------------------------
 * frontcareer - MODAL] 
 * @description: edit careers modal
 * -------------------------------------------------------------------------------------*/
 function NXAddEditFrontCareer() {

  //page section
  var page_section = $("#js-frontcareers-modal-add-edit").attr('data-section');

  //reset editor
  nxTinyMCEBasic();

  //uplaod files
  $("#fileupload_frontcareer_receipt").dropzone({
      url: "/fileupload",
      headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      },
      ...
      success: function(file, response) {
          ...
          var $preview = $(file.previewElement);
          //create a hidden form field for this file
          $preview.append('<input type="hidden" name="frontcareer[' + response.uniqueid +
              ']"  value="' + response.filename + '">');
          $preview.append('<input type="hidden" name="attachment_unique_input_document"  value="frontcareer">');
      }
  });
  /** ----------------------------------------------------------
   * create frontcareer - form validation
   * ---------------------------------------------------------*/
  if (page_section == 'create') {
      $("#commonModalForm").validate().destroy();
      $("#commonModalForm").validate({
          rules: {
              frontcareer_title: "required",
              frontcareer_experience: "required",
              frontcareer_category: "required",
              frontcareer_salary: "required",
  ...
  /** ----------------------------------------------------------
   * edit frontcareer - form validation
   * ---------------------------------------------------------*/
  if (page_section == 'edit') {
      $("#commonModalForm").validate().destroy();
      $("#commonModalForm").validate({
...
function NXAddEditProperty() {
  ...
  $("#fileupload_property_image_path").dropzone({
    ...
    success: function (file, response) {
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_property_copy"  value="property">'
      );
    },
  });
  /** ----------------------------------------------------------
...
function NXAddMail() {
  //page section
  var page_section = $("#js-mails-modal-add-edit").attr("data-section");
...
function NXAddEditFproduct() {
  ...
  //image
  $("#fileupload_fproduct_image_path").dropzone({
    url: "/fileupload",
    clickable: true,
    headers: {
      "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
    ...
    success: function (file, response) {
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_fproduct_copy"  value="fproduct">'
      );
    },
  });
 ...
 * @description: edit projects modal
 * -------------------------------------------------------------------------------------*/
function NXAddEditSubProduct() {
  //page section
  var page_section = $("#js-subproducts-modal-add-edit").attr("data-section");

  //reset editor
  nxTinyMCEBasic();

  /** ----------------------------------------------------------
   * create subproduct - form validation
   * ---------------------------------------------------------*/
  if (page_section == "create") {
    $("#commonModalForm").validate().destroy();
    $("#commonModalForm").validate({
      rules: {
        subproduct_title: "required",
        subproduct_description: "required",
        subproduct_f_product: "required",
      },
      submitHandler: function (form) {
        //ajax form, so initiate ajax request here
        nxAjaxUxRequest($("#commonModalSubmitButton"));
  ...
  /** ----------------------------------------------------------
   * edit subproduct - form validation
   * ---------------------------------------------------------*/
  if (page_section == "edit") {
    $("#commonModalForm").validate().destroy();
    $("#commonModalForm").validate({
  ...
  //image
  $("#subfileupload_subproduct_receipt").dropzone({
    url: "/fileupload",
    clickable: true,
    headers: {
      "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
    ...
    success: function(file, response) {
          ...
          var $preview = $(file.previewElement);
          //create a hidden form field for this file
          $preview.append('<input type="hidden" name="subproduct[' + response.uniqueid +
              ']"  value="' + response.filename + '">');
          $preview.append('<input type="hidden" name="attachment_unique_subproduct"  value="subproduct">');
      }
  });
...
function NXAddEditDocument() {
  ...
  $("#fileupload_document_submital_copy").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="submital_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_submital_copy" value="document_submital_copy">'
      );
    },
  });
  ...
  $("#fileupload_document_document_copy").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="document_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_document" value="document_doc_file">'
      );
    },
  });
  ...
  if (page_section == "create") {
    ...
    $("#commonModalForm").validate({
      rules: {
        ...
        document_delivered_by: "required",
...
function NXAddEditVendorRfq() {
  ...
  //uplaod files
  $("#fileupload_vendorrfq_rfq").dropzone({
    url: "/fileupload",
    headers: {
      "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
    },
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="rfq_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachment_unique_input_rfq"  value="rfq_attachments">'
      );
    },
  });

  //second files
  $("#fileupload_vendorrfq_video").dropzone({
    url: "/fileupload",
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="video_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachment_unique_input_video"  value="video_attachments">'
      );
    },
  });
...
function NXAddEditVendorInvoice() {
  //page section
  var page_section = $("#js-vendorinvoices-modal-add-edit").attr(
    "data-section"
  );
...
function NXAddEditGovtDocument() {
  ...
  $("#fileupload_govtdocument_receipt").dropzone({
    ...
    success: function (file, response) {
      ...
      $preview.append(
        '<input type="hidden" name="attachment_unique_input_document"  value="document_attachments">'
      );
    },
  });
  ...
  $("#fileupload_govtdocument_lrc").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="lrc_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachment_unique_input_lrc"  value="lrc_attachments">'
      );
    },
  });
...
function NXAddEditVendorPo() {
  ...
  $("#fileupload_vendorpo_qtn").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="qtn_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachment_unique_input_qtn"  value="qtn_attachments">'
      );
    },
  });
  ...
  $("#fileupload_vendorpo_po").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="po_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachment_unique_input_po"  value="po_attachments">'
      );
    },
  });
...
function NXAddEditRfm() {
  ...
  $("#rfm_image").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="rfm_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_rfm_image" value="rfm_image">'
      );
    },
  });
  ...
  $("#rfm_video").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="rfm_attachments_video[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_rfm_video" value="rfm_video">'
      );
    },
  });
  ...
  function NXAddEditGovtDocument() {
    //page section
    var page_section = $("#js-govtdocuments-modal-add-edit").attr(
      "data-section"
    );
    ...
    if (page_section == "create") {
      ...
      $("#commonModalForm").validate({
        rules: {
          govtdocumentype_of_document: "required",
          govtdocument_issue_date: "required",
          govtdocument_validity_date: "required",
          govtdocument_renewal_cost: "required",
          govtdocument_last_renewal_by: "required",
...
/**--------------------------------------------------------------------------------------
 * RItem - MODAL]
 * @description: edit projects modal mzadcom trustech ritem changes
 * -------------------------------------------------------------------------------------*/
function NXAddEditRItem() {
  //page section
  var page_section = $("#js-ritems-modal-add-edit").attr("data-section");

  //reset editor
  nxTinyMCEBasic();

  /** ----------------------------------------------------------
   * create ritem - form validation
   * ---------------------------------------------------------*/
  if (page_section == "create") {
    $("#commonModalForm").validate().destroy();
    $("#commonModalForm").validate({
...
function NXAddEditClients() {
  //page
  var page_section = $("#js-trigger-clients-modal-add-edit").attr(
    "data-payload"
  );

  $("#client_stamp").dropzone({
    url: "/fileupload",
    headers: {
      "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
    },
...
function NXUserUpdateAvatar() {
  ...
  $("#fileupload_avatar").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="avatar_filename"  value="' +
          response.filename +
          '">'
      );
      $preview.append(
        '<input type="hidden" name="avatar_directory"  value="' +
          response.uniqueid +
          '">'
      );
    },
...
function NXSettingsLogo() {
  ...
  $("#fileupload_single_image").dropzone({
    ...
    success: function (file, response) {
      ...
      $preview.append(
        '<input type="hidden" name="logo_size"  value="' +
          response.logo_size +
          '">'
      );
    },
...
function NXSettingsProjectsClients() {
  //sanity - ensure views are checked also
  $(
    "#settings_projects_clientperm_tasks_create, #settings_projects_clientperm_tasks_collaborate"
  ).on("change", function () {
    if ($(this).is(":checked")) {
      ...
      if (
        !$("#settings_projects_clientperm_tasks_create").is(":checked") &&
        !$("#settings_projects_clientperm_tasks_collaborate").is(":checked")
      ) {
  ...
  $("#settings_projects_clientperm_tasks_view").on("change", function () {
    if (!$(this).is(":checked")) {
      $("#settings_projects_clientperm_tasks_collaborate").prop(
        "checked",
        false
      );
...
function NXAddEditMaterial() {
  $("#material_image").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="material_image_attachment[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_material" value="material_image">'
      );
    },
  });
 ...
 * @description: edit projects modal
 * -------------------------------------------------------------------------------------*/
function NXAddEditEmployeeLegalDocument() {
  //page section
  var page_section = $("#js-employees-modal-add-edit").attr("data-section");
  ...
  $("#id_copy").dropzone({
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="id_copy_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_id_copy"  value="id_copy">'
      );
    },
  });

  //passport copy
  $("#passport_copy").dropzone({
    url: "/fileupload",
    clickable: true,
    headers: {
      "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="passport_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_passport_copy"  value="passport_copy">'
      );
    },
  });

  //passport copy
  $("#employement_contract_copy").dropzone({
    url: "/fileupload",
    clickable: true,
    headers: {
      "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
    ...
    success: function (file, response) {
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_contract_copy"  value="employement_contract_copy">'
      );
    },
  });

  //hamad card copy
  $("#hamad_card_copy").dropzone({
    url: "/fileupload",
    clickable: true,
    headers: {
      "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="hamad_card_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_hamad_card_copy"  value="hamad_card_copy">'
      );
    },
  });

  //other document
  $("#other_document").dropzone({
    url: "/fileupload",
    clickable: true,
    headers: {
      "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
    ...
    success: function (file, response) {
      ...
      //create a hidden form field for this file
      $preview.append(
        '<input type="hidden" name="others_attachments[' +
          response.uniqueid +
          ']"  value="' +
          response.filename +
          '">'
      ...
      $preview.append(
        '<input type="hidden" name="attachments_unique_input_other_document"  value="other_document">'
      );
    },
  });
